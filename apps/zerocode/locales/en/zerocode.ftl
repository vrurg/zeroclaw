...
zc-goal-status = Goal status is available.
zc-goal-budget = Goal budget is available.
zc-goal-budget-updated = Goal budget updated.
zc-goal-paused = Goal paused.
zc-goal-already-paused = Goal is already paused.
...
zc-goal-no-current = No current goal.
...
zc-goal-yes = yes
zc-goal-no = no
zc-goal-details = Status: { $status }; epoch: { $epoch }; accounting: { $accounting }; resumable: { $resumable }; token limit: { $token_limit }; cost limit USD: { $cost_limit }; pause reason: { $pause_reason }.
