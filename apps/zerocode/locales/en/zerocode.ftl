...
zc-goal-help = 🎯 Goal command help is available.
zc-goal-disabled = 🚫 Goal Mode is disabled.
zc-goal-started = 🟢 Goal started.
zc-goal-status = ℹ️ Goal status is available.
zc-goal-budget = ℹ️ Goal budget is available.
zc-goal-budget-updated = 📝 Goal budget updated.
zc-goal-paused = ⏸️ Goal paused.
zc-goal-paused-blocked = ⏸️ Goal paused.
zc-goal-paused-reason = Reason: { $reason }
zc-goal-paused-notice-action = • { $action }
zc-goal-paused-blocked-next = Next: Address this reason, then run /goal resume [RESPONSE] to continue.
zc-goal-paused-blocked-cancel = Or run /goal cancel to dismiss this Goal.
zc-goal-paused-blocked-status = Run /goal status to review the current Goal.
zc-goal-paused-core-interruption = ⏸️ Goal paused after a safety interruption. **Reason:** { $reason } **Next:** Run /goal resume to start a fresh agent operation, or /goal cancel to dismiss this Goal.
...
zc-goal-failed = ❌ Goal failed.
zc-goal-parent-error = ⚠️ Error: { $error }
zc-goal-no-current = ⚠️ No current goal.
zc-goal-already-active = ⚠️ A goal is already active.
zc-goal-response-requires-pause = ⚠️ The Goal is still running, so your response was not applied. Wait until it pauses for user input, then run /goal resume RESPONSE.
zc-goal-terminal = ⚠️ Goal is no longer resumable.
zc-goal-unlimited = unlimited
zc-goal-yes = yes
zc-goal-no = no
zc-goal-summary-status = Status: { $status }
zc-goal-summary-reason = Reason: { $reason }
zc-goal-summary-provider = Provider: { $provider }
zc-goal-summary-details = Details: { $details }
zc-goal-summary-budget = Budget: { $token_limit } tokens · USD { $cost_limit }
zc-goal-summary-accounting = Accounting: { $tokens } tokens · USD { $cost } · { $accounting }{ $incomplete }
zc-goal-summary-accounting-unavailable = Accounting: usage unavailable · { $accounting }
zc-goal-summary-accounting-incomplete = {" "}· recorded usage may be incomplete
zc-goal-summary-execution = Execution: epoch { $epoch } · resumable { $resumable }
zc-goal-summary-pause = Pause: { $pause_reason }
zc-goal-pause-description = Details: { $description }
zc-goal-blocker = Blocker: { $blocker }
zc-goal-pause-operator-paused = paused by an operator
zc-goal-pause-needs-user-input = user input is required
zc-goal-pause-human-escalation = human escalation is required
zc-goal-pause-external-dependency = an external dependency is required
zc-goal-pause-core-interrupted = recoverable agent interruption
zc-goal-pause-provider-unavailable = provider unavailable
zc-goal-pause-verifier-blocked = verification needs clarification
zc-goal-pause-budget-exhausted = budget exhausted
zc-goal-pause-budget-unavailable = budget unavailable
zc-goal-pause-daemon-restarted = service restarted
zc-goal-pause-unknown = requires attention
zc-goal-accounting-complete = complete
zc-goal-accounting-missing = usage is incomplete
zc-goal-accounting-invalid = usage is invalid
zc-goal-accounting-outcome-unknown = usage may be incomplete
zc-goal-accounting-unknown = usage state unavailable
zc-goal-terminal-reason-verified-completion = The final response was verified.
zc-goal-terminal-reason-accounting-outcome-unknown = The last model operation did not settle cleanly. Its usage may be higher than recorded, and it was not retried.
zc-goal-terminal-reason-accounting-missing-or-invalid = The model response did not provide usable usage information, so the Goal stopped rather than continue with an unreliable budget.
zc-goal-terminal-reason-pricing-unavailable = Pricing was unavailable for this cost-limited Goal.
zc-goal-terminal-reason-candidate-empty = The agent completed a turn without a final response to verify.
zc-goal-terminal-reason-parent-operation-failed = The agent's model operation failed before it produced a verified result.
zc-goal-terminal-reason-parent-context-window-exceeded = The selected model could not accept the current conversation because it exceeds that model's context window.
zc-goal-terminal-reason-verifier-operation-failed = The verification operation failed before it could decide whether the Goal was complete.
zc-goal-terminal-reason-verifier-protocol-invalid = The verifier returned an invalid completion decision.
zc-goal-terminal-reason-executor-failed = The Goal worker could not continue.
zc-goal-terminal-reason-initial-notice-failed = The Goal could not deliver its initial status notice.
zc-goal-terminal-reason-tool-pairing-incomplete = A tool operation did not settle cleanly, so the Goal stopped to avoid an unsafe retry.
zc-goal-terminal-reason-tool-loop-safety-limit = The agent reached its tool-loop safety limit before the tool results could be paired. The Goal stopped to avoid an unsafe retry.
zc-goal-terminal-reason-policy-revoked = Current policy no longer permits this Goal to run.
zc-goal-terminal-reason-session-disposed = The session was closed before the Goal could finish.
