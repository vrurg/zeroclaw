...
goal-mode-paused-blocked-guidance = Resolve the blocker, then use `/goal resume` to continue, or `/goal cancel` to dismiss this Goal. Use `/goal status` to review the current Goal.
