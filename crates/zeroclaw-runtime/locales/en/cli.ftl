...
goal-mode-paused-blocked = ⏸️ Goal paused: the verifier requires resolution. Use `/goal status` to review the details. After resolving them, use `/goal resume` to continue, or `/goal cancel` to dismiss this Goal.
