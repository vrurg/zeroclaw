...
goal-mode-paused-reason = **Reason:** { $reason }
goal-mode-paused-notice-action = • { $action }
goal-mode-paused-blocked-next = **Next:** Address this reason, then run `/goal resume [RESPONSE]` to continue.
...
goal-mode-paused-core-interruption = ⏸️ Goal paused after a recoverable agent interruption.
goal-mode-paused-core-interruption-detail = The ordinary agent error follows this update.
goal-mode-paused-core-interruption-next = **Next:** Run `/goal resume` to start a fresh agent operation, or `/goal cancel` to dismiss this Goal.
...
goal-mode-response-requires-pause = ⚠️ The Goal is still running, so your response was not applied. Wait until it pauses for user input, then run `/goal resume RESPONSE`.
...
goal-mode-summary-accounting = **Accounting:** { $tokens } tokens · USD { $cost } · { $accounting }{ $incomplete }
goal-mode-summary-accounting-unavailable = **Accounting:** usage unavailable · { $accounting }
goal-mode-summary-accounting-incomplete = {" "}· recorded usage may be incomplete
...
goal-mode-status-running = running
goal-mode-status-paused = paused
goal-mode-status-completed = completed
goal-mode-status-failed = failed
goal-mode-status-cancelled = cancelled
goal-mode-status-lost = lost
goal-mode-status-timed-out = timed out
goal-mode-pause-operator-paused = paused by an operator
goal-mode-pause-needs-user-input = waiting for your input
goal-mode-pause-human-escalation = waiting for human escalation
goal-mode-pause-external-dependency = waiting for an external dependency
goal-mode-pause-core-interrupted = recoverable agent interruption
goal-mode-pause-provider-unavailable = provider unavailable
goal-mode-pause-verifier-blocked = verifier needs clarification
goal-mode-pause-budget-exhausted = budget exhausted
goal-mode-pause-budget-unavailable = budget unavailable
goal-mode-pause-daemon-restarted = service restarted
goal-mode-accounting-complete = complete
goal-mode-accounting-missing = usage is incomplete
goal-mode-accounting-invalid = usage is invalid
goal-mode-accounting-outcome-unknown = usage may be incomplete
goal-mode-terminal-reason-verified-completion = The final response was verified.
goal-mode-terminal-reason-accounting-outcome-unknown = The last model operation did not settle cleanly. Its usage may be higher than recorded, and it was not retried.
goal-mode-terminal-reason-accounting-missing-or-invalid = The model response did not provide usable usage information, so the Goal stopped rather than continue with an unreliable budget.
goal-mode-terminal-reason-pricing-unavailable = Pricing was unavailable for this cost-limited Goal.
goal-mode-terminal-reason-candidate-empty = The agent completed a turn without a final response to verify.
goal-mode-terminal-reason-parent-operation-failed = The agent's model operation failed before it produced a verified result.
goal-mode-terminal-reason-parent-context-window-exceeded = The selected model could not accept the current conversation because it exceeds that model's context window.
...
goal-mode-terminal-reason-session-disposed = The session was closed before the Goal could finish.
