...
cli-config-patch-warning-pre-existing-validation = avertissement : {$path} est un alias de fournisseur hérité qui reste non valide et doit être réparé séparément.
