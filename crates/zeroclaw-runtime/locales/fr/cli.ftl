...
cli-quickstart-auth-anthropic-skip-hint = {"  "}Terminez plus tard avec : `claude setup-token`, puis `zeroclaw auth setup-token --model-provider anthropic --profile {$alias}` et définissez `providers.models.anthropic.{$alias}.auth_mode = "oauth"`
