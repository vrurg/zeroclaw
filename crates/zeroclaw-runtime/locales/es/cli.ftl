...
cli-quickstart-auth-anthropic-skip-hint = {"  "}Termina más tarde con: `claude setup-token`, luego `zeroclaw auth setup-token --model-provider anthropic --profile {$alias}`
