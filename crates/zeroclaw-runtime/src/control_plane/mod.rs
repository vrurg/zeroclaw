...
pub use goal::{
    ...
    apply_current_goal_approval_denial, bind_current_goal_task, cancel_goals_for_policy_revocation,
    ...
    evaluate_goal_turn, evaluate_goal_turn_with_verifier,
    goal_commands_available_on_channel, goal_ids_revoked_by_config, goal_recovery_status_message,
    ...
    pause_running_goal_for_interruption, resume_current_goal_after_human_gate,
    scope_goal_admission_context, scope_goal_runtime, scope_goal_start_tool_batch,
    scope_goal_state_updates, scope_goal_turn_evaluation_marker, with_goal_policy_update_lock,
};
