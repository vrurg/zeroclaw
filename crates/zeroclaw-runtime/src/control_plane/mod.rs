...
pub use goal::{
    ...
    bind_current_goal_task, cancel_goals_for_policy_revocation, current_goal_admission_context,
    current_goal_config, current_goal_start_tool_batch_requested,
    current_goal_turn_evaluation_marker, current_goal_turn_evaluation_requested,
    ensure_current_goal_task_binding_available, evaluate_goal_turn,
    evaluate_goal_turn_with_verifier, goal_ids_revoked_by_config, goal_recovery_status_message,
    mark_current_goal_turn_for_evaluation, pause_current_goal_for_human_gate,
    pause_goal_for_accounting_failure, pause_running_goal_for_interruption,
    reserve_current_goal_task_binding, scope_goal_admission_context, scope_goal_runtime,
...
pub use goal_task::{
    ...
    GoalTaskRecord, GoalTaskRegistry, TaskContinuationContext, TaskContinuationConversationScope,
    TaskGoal,
};
